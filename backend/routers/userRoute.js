...
const {registerNewUser,loginUser,logoutUser,forgetPassword,resetPassword,getUserDetails,updatePassword,updateProfile,getAllUsers,getUser} = require('../controllers/userController');
